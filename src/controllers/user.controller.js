...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // Handle avatar upload or default fallback
  ...
  // Handle cover image upload or default fallback
  let coverImageUrl = "";
...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (incomingRefreshToken !== user?.refreshToken) {
      throw new ApiError(401, "Refresh token is expired or has been replaced");
    }
